...
public enum TYPE_CHAMP {
	...
	/** The duree. */
	DUREE(CATEGORIE_TYPE_CHAMP.DUREE), /** The kms. */
 KMS(CATEGORIE_TYPE_CHAMP.DISTANCE), /** The miles. */
 MILES(CATEGORIE_TYPE_CHAMP.DISTANCE), /** The text. */
 TEXT(
	CATEGORIE_TYPE_CHAMP.TEXT), 
 /** The text local. */
